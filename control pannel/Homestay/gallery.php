            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="main-body">
                        ...
                        <div class="form-group"id="heading3">
                            <label for="title">Add Description (optional) </label>
                            <textarea type="text" name="description" id="catagory" class="form-control"></textarea>
                        </div>

                </div>
                    <div class="modal-footer">
                        <input type="submit" name="submit_pic" class="btn btn-primary"  id="submitBtn"  value="Upload">
                    </div>
                </form>
            </div>
        </div>
